const zhCN = {
  common: {
    product: 'Palworld Save Studio', version: '0.3.0-beta.1', beta: '界面预览版', unofficial: '非官方粉丝工具',
...
const en = {
  common: {
    product: 'Palworld Save Studio', version: '0.3.0-beta.1', beta: 'UI preview', unofficial: 'Unofficial fan tool',
