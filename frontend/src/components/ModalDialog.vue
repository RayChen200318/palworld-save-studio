...
.modal-card{width:100%;border:1px solid var(--border-violet);border-radius:14px;background:linear-gradient(150deg,rgba(20,30,48,.97),rgba(8,11,20,.98));box-shadow:var(--shadow-float);overflow:hidden}
...
.modal-body{padding:20px}.modal-card footer{display:flex;justify-content:flex-end;gap:10px;padding:15px 20px 18px;border-top:1px solid var(--border-subtle)}
