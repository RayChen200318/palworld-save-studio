...
<template>
  <button class="language-toggle" type="button" :aria-label="label" @click="store.toggleLocale">
    <span :class="{ active: store.locale === 'zh-CN' }">中</span>
    <span class="divider"></span>
    <span :class="{ active: store.locale === 'en' }">EN</span>
  </button>
</template>
