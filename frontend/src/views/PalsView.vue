...
<style scoped>
.collection-heading{margin-bottom:14px;display:flex;align-items:flex-start;justify-content:space-between;gap:20px}.collection-heading>div:first-child{display:flex;align-items:center;gap:12px}.collection-heading p{max-width:780px;margin:0;color:var(--text-muted);font-size:11px;line-height:1.6}.collection-heading>div:last-child{display:flex;gap:9px}.filter-panel{margin-bottom:12px;padding:12px;display:grid;grid-template-columns:repeat(6,minmax(120px,1fr));gap:9px}.filter-panel label>span{display:block;margin:0 0 6px;color:var(--text-faint);font-size:8px;font-weight:700;text-transform:uppercase;letter-spacing:.08em}.filter-panel .field-select{height:35px;font-size:10px}.loading{height:430px;display:grid;place-items:center;align-content:center;gap:10px;color:var(--text-muted);font-size:12px}.loading .app-icon{animation:spin 1s linear infinite}.toast{position:fixed;right:30px;bottom:28px;z-index:50;padding:12px 15px;display:flex;align-items:center;gap:9px;border:1px solid rgba(98,217,164,.28);border-radius:11px;background:rgba(11,34,39,.96);color:var(--green-300);font-size:11px;box-shadow:0 18px 48px rgba(0,0,0,.35)}.add-form{display:grid;gap:17px}.destination{padding:13px;display:flex;align-items:center;gap:10px;border:1px solid rgba(45,212,226,.16);border-radius:11px;background:rgba(25,188,209,.06);color:var(--cyan-300);font-size:11px}.error{margin:0;color:var(--red-300);font-size:11px}@keyframes spin{to{transform:rotate(360deg)}}
