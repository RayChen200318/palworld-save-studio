...
<style scoped>
.page-intro{margin:0 0 18px;color:var(--text-muted);font-size:12px;line-height:1.7}.players-grid{display:grid;grid-template-columns:310px minmax(0,1fr);gap:15px;align-items:start}.player-list{overflow:hidden}.player-list>button{width:100%;min-height:70px;padding:11px 14px;display:flex;align-items:center;gap:11px;border:0;border-bottom:1px solid var(--border-subtle);background:transparent;color:var(--text);text-align:left;cursor:pointer}.player-list>button:hover{background:var(--surface-soft)}.player-list>button.active{background:linear-gradient(90deg,rgba(31,194,212,.13),rgba(31,194,212,.02));box-shadow:inset 2px 0 var(--cyan-400)}.player-list .avatar{width:40px;height:40px;flex:0 0 40px;display:grid;place-items:center;border:1px solid rgba(53,213,225,.2);border-radius:10px;background:rgba(34,199,216,.08);color:var(--cyan-300);font-size:11px;font-weight:800}.player-list button>div{min-width:0;flex:1}.player-list strong,.player-list small{display:block;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}.player-list strong{color:var(--text-strong);font-size:11px}.player-list small{margin-top:5px;color:var(--text-muted);font-size:8px}.player-list button>.app-icon{color:var(--text-faint)}.player-editor{overflow:hidden}.player-hero{min-height:130px;padding:22px;display:flex;align-items:center;gap:17px;border-bottom:1px solid var(--border-subtle);background:radial-gradient(circle at 12% 50%,rgba(31,194,212,.1),transparent 30%)}.large-avatar{width:76px;height:76px;display:grid;place-items:center;border:1px solid rgba(53,213,225,.25);border-radius:18px;background:rgba(34,199,216,.08);color:var(--cyan-200);font-size:23px;font-weight:800}.player-hero h2{margin:9px 0 4px;color:var(--text-strong);font-size:20px}.player-hero p{margin:0;color:var(--text-faint);font-size:8px}.player-hero :deep(.status-pill){min-height:21px;font-size:8px}.editor-body{padding:22px}.editor-body section+section{margin-top:23px;padding-top:21px;border-top:1px solid var(--border-subtle)}.editor-body h3{margin:0 0 13px;color:var(--text-strong);font-size:13px}.form-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:12px}.option-row{display:flex;align-items:center;justify-content:space-between}.option-row h3{margin-bottom:5px}.option-row p{margin:0;color:var(--text-faint);font-size:9px}.switch input{position:absolute;opacity:0}.switch span{width:44px;height:24px;padding:2px;display:block;border:1px solid var(--border-subtle);border-radius:99px;background:#112433}.switch span:before{content:"";display:block;width:18px;height:18px;border-radius:50%;background:var(--text-faint);transition:.18s}.switch input:checked+span{background:rgba(34,199,216,.15);border-color:rgba(34,199,216,.3)}.switch input:checked+span:before{transform:translateX(19px);background:var(--cyan-300)}.technology-link{margin-top:23px;padding:14px;display:flex;align-items:center;justify-content:space-between;border:1px solid var(--border-subtle);border-radius:12px;background:var(--surface-soft)}.technology-link>div{display:flex;align-items:center;gap:11px;color:var(--gold-300)}.technology-link strong,.technology-link small{display:block}.technology-link strong{color:var(--text-strong);font-size:11px}.technology-link small{margin-top:4px;color:var(--text-muted);font-size:8px}.error{color:var(--red-300);font-size:10px}.empty{padding:80px;color:var(--text-muted);text-align:center}
